/*
    객체란: 속성(propertity) 와 함수(function)를 하나로 묶은 자료
        - 변수명.속성명         : 객체내 속성값
        - 변수명.속성명()       : 객체내 함수 호출
    ...
    [DOM객체]
        ...
        3. 내장객체내 주요 속성
            ...
            2. ducoment.querySelector('선택자')         :HTML에 지정한 선택자를 JS객체로 *반환*하는 함수
            3. ducoment.querySelectorAll('선택자')      :HTML에 지정한 선택자를 모두 JS객체로*반환*하는 함수
            *선택자: 1.마크업명 2. .클래스명 3. #wid명
        4. dom객체.innerHTML                        :마크업내 html 호출 하는 속성
            * <마크업> innerHTML 입니다. </마크업>
            * inner 없음 : <input />. <img /> 등등 (혼자서 / 닫는애들)
        5. dom객체.value.
            * <마크업 *value="여기!!!" />
            * value있음 : <iuput>, <select>, <textarea> 등등
        ...
        8. dom객체.classList                      :마크업내 적용된 class들 반환
            ...
            dom객체.classList.contains('클래스명') :마크업내 지정클래스가 있는지 확인, true/false 변환
*/          
//[1]
...
console.log(html);  // <div> 박스1 </div> --> 박스1<--inner
//[6]
...
function func3(){
    ...
    //2. 해당 마크업객체내 .style속성
    title2.style='color:red; font-size:30px'; //css문법 문자열로 대입
