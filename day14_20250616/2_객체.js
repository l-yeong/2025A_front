...
// const  person={'name':'이찬영', 'age':'비밀', 'city':'부천'};
// console.log(person)
...
//   pages: 500
// };
// // 1. 객체내 모든 값 반환 (배열) 반환 : Object.values()
...
//     const key=names[i]; //index번째의 속성/key명 호출
//     if(inventory[key] <10){ //만약에 index번째 key값이 10미만이면
//         console.log(key);
//     }
// }
