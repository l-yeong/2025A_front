...
// 출력함수.js
// - HTML 과 CSS 와 달리 JS는 프로그래밍 언어 이다.
...
// [출력함수] : 
// 1. console.log( 출력할 자료 )                           : 개발자 도구[F12]  에서 console[탭]에 출력된다.
console.log( 10 )
console.log( "안녕하세요" )
...
//3.document.write( HTML 문법)                              :document(HTML파일).write(쓰다) : html 문서에 출력한다
document.write( "<h3> JS에서 작성한 HTML 입니다. 안녕하세요. </h3>" ) // 거의 쓸일 음

//4.docment.querySlector("선택자"). innerHTML = HTML = HTML  : 특정한 선택자( 마크업, CLASS, ID)의 출력한다.
    // -> innerHTML : <마크업> (여기까지 inner) </마크업> : 마크업 사이 
