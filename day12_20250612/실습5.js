...
//[문제1] 계속 추가 됌
// let fruiseach=prompt("과일 입력 :");
// let fruitList = [ '사과', '바나나' ];

// if(fruitList.indexOf(fruiseach) == -1){
//     fruitList.push(fruiseach);
//     console.log(fruitList);
// }else{
//     console.log("이미 존재하는 과일 입니다.");
// }
...
// if(금액>=50000){
//     console.log(금액-(금액*0.1)": 10%할인금액");
// }else if(금액 >=30000){
//     console.log(금액-(금액*0.05)": 5%할인금액");
// }else if(금액>=10000){
//     console.log(금액-(금액*0.01)": 1%할인금액");
// }else{
//     console.log("할인 없음")
// }
...
// let maxcount1=Number(prompt("숫자 입력1: "))
// let maxcount2=Number(prompt("숫자 입력2: "))
// let maxcount3=Number(prompt("숫자 입력3: "))

// if(maxcount1 > maxcount2 && maxcount1 > maxcount3){
//     console.log(`${maxcount1}[1]`)
// }else if(maxcount2 > maxcount3 && maxcount2 > maxcount1){
//     console.log(`${maxcount2}[2]`)
// }else
// if(maxcount3 > maxcount1 && maxcount3 > maxcount2){
//     console.log(`${maxcount3}[3]`)
// }else{("없음")}
...
// A > B 비교하기 A 가 더크면 A 와 B의 위치를 변경/스왑

////(5) 조건 : num1 > num2, num1 > num3, num2 > num3
// let temp;
// if( numArray[0] > numArray[1]){ //첫번째 값이 두번째 값보다 크면 (스왑/교체)
//     temp = numArray[0];         //임시변수에 첫번째 값을 넣고
//     numArray[0]=numArray[1];    //첫번째 위치에 두번째 값을 넣고
//     numArray[1] = temp;         //두번째 위치에 임시변수(첫번째값) 값을 넣고
// }
// // else if[x]: 다수 조건에 따른 다수처리(스왑) 해야 하므로 안됨
// if(numArray[0] > numArray[2]){ //첫번째 값이 세번째 값보다 크면(스왑/교체)
//     temp=numArray[0];
//     numArray[0]=numArray[2];
//     numArray[2]=temp;
// }
// if(numArray[1] > numArray[2]){ //두번째 값이 세번째 값보다 크면 (스왑/교체)
//     temp=numArray[1];
...
//[8번문제]
////조건: 플레이어가 이기는 경우의수(3), 지는수(3), 비기는수(3)
/*
    (방법1: 모든 경우의수 판단)
    이기는수 : 가위 = 보, 바위=가위, 보=가위 : 0=2, 1=0, 2=1
    비기는수 : 가위=가위, 바위=바위, 보=보 :   0=0, 1=1, 2=2
    지는수  :가위=보, 바위=보, 보=가위 :       0=1, 1=2 , 2=0
    (방법2: 모든 경의수 패턴 찾기)
    1. 두 수가 같으면 무승부이다.
        0 == (2+1)%3
        1 == (0+1)%3
        2 == (1+1)%3
    2. 플레이어2 값의 +1 하고 나누기 3했을때 나머지 플레이어1 과 같으면 플레이어1 승리
*/ 
////(방법1)
// let player1=Number(prompt("0~2 입력 : "))
// let player2=Number(prompt("0~2 입력 : "))
// if( player1 == player2){
//     console.log('무승부');
// }else if((player1 == 0 && player2 ==2)||(player1==1 &&player2==0)||player1==2 && player2 ==1){
//     console.log('플레이어1 승')
// }else( console.log("플레이어2 승"))
////(방법2)
// let player1=Number(prompt("0~2 입력 : "))
// let player2=Number(prompt("0~2 입력 : "))
// if( player1 == player2){
//     console.log('무승부');
// }else if(player1 == 0 && (player2 + 1)%3){
//     console.log('플레이어1 승')
// }else( console.log("플레이어2 승"))
