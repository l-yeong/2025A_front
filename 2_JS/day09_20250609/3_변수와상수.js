...
[변수]
    ...
    4. 형태
        ...
        2. 변수명   : 메모리 공간의 상징적인 이름       * 카멜표기법 : mycar -> myCar, studnetScore -> studentScore
        3. =        : 오른쪽 항 을 외쪽 항에 대입/할당/넣는다.
        4. 자료     : 변수에 저장할 재료

[상수]
    1. 정의 : 하나의 자료/데이터를 담아두는 공간 이면ㅇ서 수정 불가능 변수
    2. 목적 : 절댓값, 협업
    3. 사용법
        const 변수명 * 초기값       *상수는 무조건 초기값이 필요 하다.
    4. 형태
...
// 3. 상수의 값을 수정하는 방법, X 불가능
이름3="신동엽2" //오류발생 : Assignment to constant variable.

// [생각해보기1]
let point = 50                      //변수명 : point , 리터럴 : 50
let point4= 50                      // 2개이상 이여도 상수 이기 때문에 공유해서 1개로 취급
let point2 = 100                    //변수명 : point2, 리터럴 : 100
let point3 = point + point2         //변수명 : point3, 리터럴 : 150
    // 위 코드에서 총 리터럴의 개수 3개
    // + 연산 : 하나의 결과를 도출하는 행위


let width       //'width' 이름으로 변수 선언한다.
let height      // 'height' 이름으로 변수 선언한다.
