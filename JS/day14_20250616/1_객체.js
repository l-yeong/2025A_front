...
// [3] 객체 선언시 속성(properties) 구성, {속성명 : 자료, 속석명 : 자료 }
// - 속성명 과 자료 의 한쌍(entry) 하고, (쉼표) 구분하여 여러개 entry 를 { } 감싼다.
// - 속명명은 임의로 작성하되, 특수문자가 포함된 경우 "" or ''
...
// [4] 객체 호출
    ...
    // 변수명[속성명]       : 특정한 속성의 자료 호출 * 속성명이 특수한문자포함 또는 변수 일때
    // Object.keys (객체변수)   : 객체 내 모든 속성명(key) 를 배열로 반환
...
console.log(Object.keys(obj2));    //['속성멷1', '속성명2']
console.log(Object.values(obj2));  //[10,'hello']
console.log(Object.entries(obj2)); //[['속성명',10],['속성명','hello']]


// [5] 객체내 속성 추가, 변수명.새로운속성명 = 자료, 변수명["새로운 속성명"]=자료
obj2.속성명3 = true;
console.log(obj2);  // {속성명1: 10, 속성명2: 'hello', 속성명3: true}
obj2["속성명3"]=false;
console.log(obj2); // {속성명1: 10, 속성명2: 'hello', 속성명3: false}

// [6] 객체내 속성 수정, 변수명.속성명 = 새로운 자료
obj2. 속성명1 = 20;
console.log(obj2);  //{속성명1: *20, 속성명2: 'hello', 속성명3: false}

// [7] 객체내 속성 삭제, delete변수명.삭제속성명
delete obj2.속성명3;
console.log(obj2); // {속성명1: 20, 속성명2: 'hello'}

//[8] 객체 속성내 자료, 자료에는 변수값, 리터럴값, 객체, 배열, 함수 등 모든 자료가 대입된다.
let var1 = 10;
const var2= { props1 : 3.14, 
              props2 : var1, 
              props3 : { }, 
              props4 : { },
              props5 : function(){}
...
// [10] 배열 과 객체 관계 조합
// - 공통점 : 여려개 자료들을 하나의 자료로 묶는다.
// - 차이점 : 배열(인덱스로 자료로 구분) vs 객체(속성명으로 자료 구분)
// - 동일한 자료의 의미를 가질때는 배열, 서로 다른 자료의 의미를 가질때는 객체
// ['콜라', 1000] -> 배열 보다는 격체 권장!!!
